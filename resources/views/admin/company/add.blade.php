	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="username" name="com_name">
			</div>
		</div>
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>性质：</label>
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="com_type" type="radio" id="status-1" value="1" checked>
					<label for="status-1">企业</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="status-2" name="com_type" value="2">
					<label for="status-2">学校</label>
				</div>
			</div>
		</div>
