...
<div class="header" style="background: rgba(8,96,186, 0.1);"><h2 style="color: white;">&nbsp;&nbsp;&nbsp;职场社交-后台登录</h2></div>
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/admin/public/check" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="" type="submit" class="btn btn-primary radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;" style="background: rgba(103,169,214, 0.2);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input name="" type="reset" class="btn btn-default radius size-L" value="&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;" style="background: rgba(106,169,214, 0.2); color: white;">
        </div>
      </div>
    </form>
  </div>
</div>
<div class="footer" style="background: rgba(8,96,186, 0.1);">Copyright © 2010 - 2019 Workplace. All Rights Reserved.</div>
