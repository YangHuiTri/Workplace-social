...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a style="pointer-events: none;" class="logo navbar-logo f-l mr-10 hidden-xs" href="">Workplace-social</a>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li>
						<a data-href="/admin/comment/index" data-title="评论列表" href="javascript:;">评论列表</a>
					</li>
		...
		<dl id="menu-comments">
			<dt><i class="Hui-iconfont">&#xe636;</i> 履历管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="/admin/resume/index" data-title="履历列表" href="javascript:;">履历列表</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/member/deleted" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
		...
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/public/charts" data-title="注册统计图" href="javascript:void(0)">注册统计图</a></li>
					<li><a data-href="/admin/public/charts2" data-title="职位统计图" href="javascript:void(0)">职位统计图</a></li>
					<li><a data-href="/admin/public/charts3" data-title="动态统计图" href="javascript:void(0)">动态统计图</a></li>
				</ul>
			</dd>
		</dl>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/admin/public/charts"></iframe>
	</div>
</div>
</section>
...
function myselfinfo(){
	layer.open({
		...
		shade:0.4,
		title: '查看信息',
		content: '<div align="center"><h4>~~~我是管理员，我天不怕地不怕的，信息自己都不给看！</h4></div>'
	});
}
